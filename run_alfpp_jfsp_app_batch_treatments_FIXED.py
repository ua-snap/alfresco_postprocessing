...
out_path = '/atlas_scratch/malindgren/ALFRESCO_PostProcessing/JFSP_tx2/AlaskaFireManagementOptions_treatments_fixed' # this is the base out dir
...
for group in treatment_groups:
	...
	if treatment == 'tx2':
		alf_runs = os.listdir(os.path.join(base_path2, group))
	else:
