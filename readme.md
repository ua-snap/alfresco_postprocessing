...
**Python Module for calculating summary statistics across the Geospatial Raster (GeoTiff) outputs from the ALFRESCO Fire Dynamics Model [snap.uaf.edu](https://www.snap.uaf.edu/projects/alfresco-habitat)**
