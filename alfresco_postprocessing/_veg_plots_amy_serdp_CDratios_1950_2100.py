...
if __name__	 == '__main__':
	...
	for model in models:
		...
		plot_title = 'Conifer:Deciduous Ratios %s %d-%d \n ALFRESCO, %s, RCP 8.5 \n Upper Tanana Hydrological Basin' % ( 'SERDP', 1950, 2100, model )
		figsize = ( 14, 8 )
		plt.title( plot_title , y=1.08 )

		# limits
		years = ratios.index.astype( int ).tolist() # HACK!
		plt.xlim( min(years), max(years) )
		
		# ticks
		ticks = range( 1960, 2101, 20 )
		# ticks.insert( 0, 1950 )
		...
		# save it/close
		plt.savefig( '/workspace/Shared/Users/malindgren/AMY_SERDP/ALFRESCO_CD_ratios_'+model+'_'+scenario+'_1950_2100.png', figsize=figsize, dpi=600, bbox_inches='tight', pad_inches=0.2 )
		plt.close( 'all' )
